#!bash
# Dieses Script erstellt die deutschen Sprachpakete automod_de_x.y.z.zip und automod_de-x-sie_x.y.z.zip
...
# de-x-sie
git archive $VERBOSE --output automod_de-x-sie_$VERSION.zip intl-de root/language/de_x_sie
echo "* Deutsches Sprachdateienpaket (Sie) unter automod_de-x-sie_$VERSION.zip erstellt"
